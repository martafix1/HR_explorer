...
hr_ref = None
hr_sensorName = "None"
if("hr_kalenji" in loadedData.keys()):
    hr_ref = loadedData["hr_kalenji"]
    hr_sensorName ="kalenji chestband"
elif("hr_fr235" in loadedData.keys()):
    hr_ref = loadedData["hr_fr235"]
    hr_sensorName ="fr235 sportswatch"
else:
    pass
...
ele_bin = 0
azi_bin = 3
range_bin = 14-  params["i_Range_begin"]
